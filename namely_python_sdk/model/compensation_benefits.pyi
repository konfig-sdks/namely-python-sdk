...
class CompensationBenefits(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address1", "address2", "city", "country_id", "state_id", "zip", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address1", "address2", "city", "country_id", "state_id", "zip", ], str]):
