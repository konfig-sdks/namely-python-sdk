...
class JobsInfoCreateJobTierResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['JobsInfoCreateJobTierResponseLinks']:
                return JobsInfoCreateJobTierResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['JobsInfoCreateJobTierResponseLinked']:
                return JobsInfoCreateJobTierResponseLinked
            __annotations__ = {
                "job_tiers": job_tiers,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'JobsInfoCreateJobTierResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'JobsInfoCreateJobTierResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['JobsInfoCreateJobTierResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['JobsInfoCreateJobTierResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['JobsInfoCreateJobTierResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['JobsInfoCreateJobTierResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
