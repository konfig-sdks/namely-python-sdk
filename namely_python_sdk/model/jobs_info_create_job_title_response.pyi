...
class JobsInfoCreateJobTitleResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['JobsInfoCreateJobTitleResponseLinks']:
                return JobsInfoCreateJobTitleResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['JobsInfoCreateJobTitleResponseLinked']:
                return JobsInfoCreateJobTitleResponseLinked
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'JobsInfoCreateJobTitleResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'JobsInfoCreateJobTitleResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['JobsInfoCreateJobTitleResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['JobsInfoCreateJobTitleResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['JobsInfoCreateJobTitleResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['JobsInfoCreateJobTitleResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
