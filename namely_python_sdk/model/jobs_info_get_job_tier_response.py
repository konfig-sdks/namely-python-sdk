...
class JobsInfoGetJobTierResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['JobsInfoGetJobTierResponseLinks']:
                return JobsInfoGetJobTierResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['JobsInfoGetJobTierResponseLinked']:
                return JobsInfoGetJobTierResponseLinked
            __annotations__ = {
                "job_tiers": job_tiers,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'JobsInfoGetJobTierResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'JobsInfoGetJobTierResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['JobsInfoGetJobTierResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['JobsInfoGetJobTierResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['JobsInfoGetJobTierResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['JobsInfoGetJobTierResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
