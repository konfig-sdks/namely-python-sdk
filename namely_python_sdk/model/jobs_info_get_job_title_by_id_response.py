...
class JobsInfoGetJobTitleByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['JobsInfoGetJobTitleByIdResponseLinks']:
                return JobsInfoGetJobTitleByIdResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['JobsInfoGetJobTitleByIdResponseLinked']:
                return JobsInfoGetJobTitleByIdResponseLinked
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'JobsInfoGetJobTitleByIdResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'JobsInfoGetJobTitleByIdResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['JobsInfoGetJobTitleByIdResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['JobsInfoGetJobTitleByIdResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['JobsInfoGetJobTitleByIdResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['JobsInfoGetJobTitleByIdResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
