...
class Like(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['LikeLinks']:
                return LikeLinks
            __annotations__ = {
                "id": id,
                "href": href,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'LikeLinks': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "href", "full_name", "job_title", "links", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['LikeLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "href", "full_name", "job_title", "links", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['LikeLinks', schemas.Unset] = schemas.unset,
