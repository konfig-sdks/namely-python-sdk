...
class NotificationsGetProfileNotificationsResponseLinked(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class job_titles(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JobTitleLink']:
                        return JobTitleLink
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JobTitleLink'], typing.List['JobTitleLink']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'job_titles':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JobTitleLink':
                    return super().__getitem__(i)
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["profiles", "job_titles", "files", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["profiles", "job_titles", "files", ], str]):
    ...
    ) -> 'NotificationsGetProfileNotificationsResponseLinked':
        return super().__new__(
            cls,
            *args,
            profiles=profiles,
