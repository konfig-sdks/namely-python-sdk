...
class Office(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address1", "address2", "city", "state_id", "country_id", "zip", "phone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address1", "address2", "city", "state_id", "country_id", "zip", "phone", ], str]):
