...
class PostProfilesResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def linked() -> typing.Type['PostProfilesResponseLinked']:
                return PostProfilesResponseLinked
            __annotations__ = {
                "profiles": profiles,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'PostProfilesResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['PostProfilesResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        linked: typing.Union['PostProfilesResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
