...
class ProfileFieldsCreateProfileFieldResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['ProfileFieldsCreateProfileFieldResponseLinks']:
                return ProfileFieldsCreateProfileFieldResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['ProfileFieldsCreateProfileFieldResponseLinked']:
                return ProfileFieldsCreateProfileFieldResponseLinked
            __annotations__ = {
                "fields": fields,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'ProfileFieldsCreateProfileFieldResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'ProfileFieldsCreateProfileFieldResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['ProfileFieldsCreateProfileFieldResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['ProfileFieldsCreateProfileFieldResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['ProfileFieldsCreateProfileFieldResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['ProfileFieldsCreateProfileFieldResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
