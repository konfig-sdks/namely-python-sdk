...
class ProfileFieldsGetAllFieldsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def links() -> typing.Type['ProfileFieldsGetAllFieldsResponseLinks']:
                return ProfileFieldsGetAllFieldsResponseLinks
        
            @staticmethod
            def linked() -> typing.Type['ProfileFieldsGetAllFieldsResponseLinked']:
                return ProfileFieldsGetAllFieldsResponseLinked
            __annotations__ = {
                "fields": fields,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'ProfileFieldsGetAllFieldsResponseLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'ProfileFieldsGetAllFieldsResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['ProfileFieldsGetAllFieldsResponseLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['ProfileFieldsGetAllFieldsResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        links: typing.Union['ProfileFieldsGetAllFieldsResponseLinks', schemas.Unset] = schemas.unset,
        linked: typing.Union['ProfileFieldsGetAllFieldsResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
