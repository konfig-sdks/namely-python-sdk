...
class ProfileMeta(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "total_count", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "total_count", "status", ], str]):
