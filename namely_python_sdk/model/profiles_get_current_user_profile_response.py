...
class ProfilesGetCurrentUserProfileResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def linked() -> typing.Type['ProfilesGetCurrentUserProfileResponseLinked']:
                return ProfilesGetCurrentUserProfileResponseLinked
            __annotations__ = {
                "profiles": profiles,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'ProfilesGetCurrentUserProfileResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['ProfilesGetCurrentUserProfileResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        linked: typing.Union['ProfilesGetCurrentUserProfileResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
