...
class ProfilesGetProfileByIdResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def linked() -> typing.Type['ProfilesGetProfileByIdResponseLinked']:
                return ProfilesGetProfileByIdResponseLinked
            __annotations__ = {
                "profiles": profiles,
                "meta": meta,
                "links": links,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["linked"]) -> 'ProfilesGetProfileByIdResponseLinked': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["linked"]) -> typing.Union['ProfilesGetProfileByIdResponseLinked', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        linked: typing.Union['ProfilesGetProfileByIdResponseLinked', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
