...
class UpdateGroupTypePayload(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "x_groups_as_teams", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "x_groups_as_teams", ], str]):
