...
class RequiredPostProfilesResponseLinked(TypedDict):
    pass

class OptionalPostProfilesResponseLinked(TypedDict, total=False):
...
class PostProfilesResponseLinked(RequiredPostProfilesResponseLinked, OptionalPostProfilesResponseLinked):
    pass
