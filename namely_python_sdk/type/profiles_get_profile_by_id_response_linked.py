...
class RequiredProfilesGetProfileByIdResponseLinked(TypedDict):
    pass

class OptionalProfilesGetProfileByIdResponseLinked(TypedDict, total=False):
...
class ProfilesGetProfileByIdResponseLinked(RequiredProfilesGetProfileByIdResponseLinked, OptionalProfilesGetProfileByIdResponseLinked):
    pass
